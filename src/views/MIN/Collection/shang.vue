...
<script>
    export default {
		...
		mounted(){
			 this.$http.jsonp("http://favorite.mogujie.com/jsonp/recommendShop/1?pf=mgjh5"
...
.coll li{ width: 45%;float: left;margin-left: .13rem; height: 2.4rem;margin-top: .2rem;background: white;}
